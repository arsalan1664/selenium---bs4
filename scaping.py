...
class GoogleMapScraper:
    ...
    def parse_contact(self, business):
        try:
            ...
            if ("03" or "+92" or "021") not in contact:
                try:
                    contact = business.find_elements(By.CLASS_NAME, "W4Efsd")[4].text.split("·")[-1].strip()
                except:
                    contact = ""
            elif ("03" or "+92" or "021") not in contact:
                try:
                    contact = business.find_elements(By.CLASS_NAME, "W4Efsd")[5].text.split("·")[-1].strip()
                except:
                    contact = ""

            elif ("03" or "+92" or "021") not in contact:
                try:
                    contact = business.find_elements(By.CLASS_NAME, "W4Efsd")[6].text.split("·")[-1].strip()
                except:
                    contact = ""
...
urls = [
    "https://www.google.com/maps/search/software+house+in+gulshan+e+iqbal+karachi/@24.9176285,67.0694907,14z/data=!3m1!4b1?entry=ttu"
]
